...
event_configs = {
    ...
    "250405시험": {
        "이벤트기간": (datetime(2025, 4, 5), datetime(2025, 4, 18)),
        "정액시간권": {
            "50시간": {"이벤트상품": "55시간", "price": [85000]},
            "100시간": {"이벤트상품": "110시간", "price": [135000]},
        },
    ...
    "250512가정의달": {
        "이벤트기간": (datetime(2025, 5, 12), datetime(2025, 5, 18)),
        "정액시간권": {
            "100시간": {"이벤트상품": "110시간", "price": [135000]},
        },
        "기간권": {
    ...
    "250623시험": {
        "이벤트기간": (datetime(2025, 6, 23), datetime(2025, 6, 30)),
        "정액시간권": {
            "100시간": {"이벤트상품": "110시간", "price": [135000]},
        },
        "기간권": {
    ...
    "250726여름": {
        "이벤트기간": (datetime(2025, 7, 26), datetime(2025, 8, 8)),
        "정액시간권": {
            "100시간": {"이벤트상품": "110시간", "price": [135000]},
        },
        "기간권": {
    ...
    "250927가을": {
        "이벤트기간": (datetime(2025, 9, 27), datetime(2025, 10, 5)),
        "정액시간권": {
            "100시간": {"이벤트상품": "110시간", "price": [135000]},
        },
        "기간권": {
